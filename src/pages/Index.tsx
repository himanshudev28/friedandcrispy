      ...
      <section className="relative pt-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-24 md:py-36 relative">
          <div className="max-w-2xl">
            ...
            >
              Taste the <span className="text-primary">Flame</span>,<br />
              Feel the Flavor
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              Experience premium dining with our handcrafted recipes, fresh ingredients, and bold flavors that keep you
              coming back.
            </motion.p>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              <Link to="/menu">
                <Button
                  size="lg"
                  className="text-lg px-8 py-6 rounded-full font-body shadow-lg hover:shadow-xl transition-shadow"
                >
                  View Menu
                </Button>
              </Link>
            ...
            {categories.map((cat, i) => (
              ...
              >
                <Link
                  ...
                  className="block p-6 rounded-xl bg-card border hover:border-primary/50 hover:shadow-lg transition-all text-center group"
                >
